...
넷플릭스가 나머지 OTT에 비해 압도적으로 강세. 또한 다른 OTT 서비스는 사실상 후발 주자였다.
따라서 OTT 흥행 시기를 넷플릭스를 기준으로 잡게 되었다.
...
영화관에 가서 가정에서 느낄 수 없는 좀 더 몰입감 있고 좋은 화면, 재밌고 흥미로운 경험을 하고 싶어하는 경향이 있음을 알 수 있다.
...
모든 가설이 다 분석 결과로 검증되었다. 
다만 생각지 못한 멜로/로맨스, 판타지 등의 장르도 지속적인 수요가 있는 것으로 보였다.


#### 2. 영화관과 OTT 산업의 방향성

최근 영화관은 콘서트, 팬미팅 상영, 뮤지컬 영화 싱어롱 상영 등 단순한 스크린의 변화 뿐만 아니라 다양한 문화 생활에 좀 더 초점이 맞춰지고 있다. 
